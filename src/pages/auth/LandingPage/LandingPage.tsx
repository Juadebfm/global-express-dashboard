...
export function LandingPage(): ReactElement {
  ...
  // Internal auth takes priority over lingering Clerk cookie/session.
  ...
  if (effectiveRole === 'staff' || effectiveRole === 'admin' || effectiveRole === 'superadmin') {
  ...
  // Default unauthenticated entrypoint
